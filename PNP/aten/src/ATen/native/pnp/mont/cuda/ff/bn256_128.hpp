...
static __device__ __constant__ __align__(16) const uint32_tALT_BN128_rx4[8] = {/* left-aligned value of the modulus */
...
struct BN256_Fr_G1 : public bn256_fr_mont {
  using mem_t = BN256_Fr_G1;
  __device__ __forceinline__ BN256_Fr_G1() {}
  __device__ __forceinline__ BN256_Fr_G1(const bn256_fr_mont& a)
      : bn256_fr_mont(a) {}
};
...
static __device__ __constant__ __align__(16) const uint32_tALT_BN128_one[8] = {/* (1<<256)%P */
                        TO_CUDA_T(0xd35d438dc58f0d9d),
                        TO_CUDA_T(0x0a78eb28f5c70b3d),
                        TO_CUDA_T(0x666ea36f7879462c),
                        TO_CUDA_T(0x0e0a77c19a07df2f)};
                        
static __device__ __constant__ __align__(16) const uint32_tALT_BN128_Px4[8] = {/* left-aligned value of the modulus */
...
struct BN256_Fq_G1 : public bn256_fq_mont {
  using mem_t = BN256_Fq_G1;
  using coeff_t = BN256_Fr_G1;
  
  __device__ __forceinline__ BN256_Fq_G1() {}
  __device__ __forceinline__ BN256_Fq_G1(const bn256_fq_mont& a)
      : bn256_fq_mont(a) {}
};

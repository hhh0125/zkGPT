...
def read_pp_data(filename, limbs):
    ...
    np.savez('/home/zhiyuan/MERKLE Arithmetization/MERKLE-HEIGHT-9/pp-9.npz', **pp_dict)
...
def read_pk_data(filename, limbs):
    ...
    # Save the dictionary to a binary file using numpy.savez
    np.savez('/home/zhiyuan/MERKLE Arithmetization/MERKLE-HEIGHT-9/pk-9.npz', **data)
...
def read_cs_data(filename, limbs):
    ...
    np.savez('/home/zhiyuan/MERKLE Arithmetization/MERKLE-HEIGHT-9/cs-9.npz', **data)
...
def read_scalar_data(filename):
    ...
    output_filename = filename.split('.')[0] + '_scalar-9.npy'
...
read_pk_data("/home/zhiyuan/MERKLE Arithmetization/MERKLE-HEIGHT-9/pk-9.txt", 4)
read_pp_data("/home/zhiyuan/MERKLE Arithmetization/MERKLE-HEIGHT-9/params-9.txt", 6)
read_cs_data("/home/zhiyuan/MERKLE Arithmetization/MERKLE-HEIGHT-9/cs-9.txt", 4)
read_scalar_data("/home/zhiyuan/MERKLE Arithmetization/MERKLE-HEIGHT-9/w_l_scalar-9.txt")
read_scalar_data("/home/zhiyuan/MERKLE Arithmetization/MERKLE-HEIGHT-9/w_r_scalar-9.txt")
read_scalar_data("/home/zhiyuan/MERKLE Arithmetization/MERKLE-HEIGHT-9/w_o_scalar-9.txt")
read_scalar_data("/home/zhiyuan/MERKLE Arithmetization/MERKLE-HEIGHT-9/w_4_scalar-9.txt")

...
import numpy as np
from py_plonk.load import load,load_pk_new
import gc
...
def compute_quotient_poly(
    ...
    del w_l_poly, w_r_poly, w_o_poly, w_4_poly
    
    # del pk_new

    # gc.collect()
    # torch.cuda.empty_cache()
    # pk_new=load_pk_new("/home/whyin/data/MERKLE Arithmetization/MERKLE-HEIGHT-15/")
    ...
    del wl_eval_8n,wr_eval_8n,wo_eval_8n,w4_eval_8n
    
    numerator = F.add_mod(gate_constraints, permutation)
    del gate_constraints,permutation
